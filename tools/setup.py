...
#######################
#  HAAS_WWII_REBALANCE Setup Script  #
#######################
...
######## GLOBALS #########
MAINDIR = "z"
PROJECTDIR = "haas_wwii_rebalance"
##########################
...
def main():
    ...
    print("""
  ######################################
  # HAAS_WWII_REBALANCE Development Environment Setup #
  ######################################

  This script will create your HAAS_WWII_REBALANCE dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your HAAS_WWII_REBALANCE project folder:
    [Arma 3 installation directory]\\{} => HAAS_WWII_REBALANCE project folder
    P:\\{}                              => HAAS_WWII_REBALANCE project folder
