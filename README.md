...
<p align="left">
    <a href="https://github.com/Drofseh/Haas_WWII_Rebalance/releases/latest">
        <img src="https://img.shields.io/badge/Version-1.17.1-blue.svg" alt="Haas WWII Rebalance Version">
    </a>
...
* The optional Hass_ACE3_Tracers_Compat also requires the ACE_Tracers pbo found in the optionals folder of the ACE3 mod.
...
* The optional Haas_Command_Vics also requires an ACRE2 dev branch build and IFA3/ACRE2 and FOW/ACRE2 compats (none of which have been released yet but are coming soon™).
...
* Corrects the descriptions and display names of weapons and magazines
...
* Other things not listed here, read the changelogs or the code.
