class CfgPatches {
 class Haas_WWII_Rebalance {
   ...
   requiredAddons[] = {"ww2_assets_c_vehicles_weapons_c","WW2_Assets_c_Weapons_Misc_c_Weapons","ww2_assets_c_weapons_weaponsmagazines_c","ww2_assets_c_weapons_infantryweapons_c","ww2_assets_c_weapons_weaponparameters_c","ww2_assets_c_weapons_recoil_c","fow_weapons","fow_weapons_c","fow_veh_weapons_c","fow_main"};
  };
 }; //End CfgPatches
