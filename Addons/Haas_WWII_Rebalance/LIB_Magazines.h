...
class LIB_1Rnd_RPzB : CA_LauncherMagazine {
 ...
 class LIB_30Rnd_45ACP : CA_Magazine {
  ...
  displayName = "M1A1 Thompson 30 Round Magazine";
 };
  class LIB_20Rnd_45ACP_M1_2PzD : LIB_30Rnd_45ACP {
   count = 20;
   descriptionShort = ".45 ACP, 20 Rounds, for use in M1A1 Thompson";
   displayName = "M1A1 Thompson 20 Round Magazine";
  };

 class LIB_30Rnd_792x33 : CA_Magazine {
  descriptionShort = "7.95x33mm, 30 Rounds, for use in MP44";
  displayName = "MP44 30 Round Magazine";
 };
 ...
 class LIB_50Rnd_792x57 : CA_Magazine {
  ...
  class LIB_50Rnd_792x57_SMK : LIB_50Rnd_792x57 {
   descriptionShort = "7.92x57mm, 50 Rounds, S.m.K. AP, for use in MG42";
   displayName = "MG42 50 Round Drum, S.m.K. AP";
  };
  class LIB_50Rnd_792x57_sS : LIB_50Rnd_792x57 {
   descriptionShort = "7.92x57mm, 50 Rounds, S.m.E. Semi-AP, for use in MG42";
